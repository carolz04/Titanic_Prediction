...
from src.config import titanic_config
import argparse
import mlflow
...
if __name__ == "__main__":
    ...
    mlflow.set_experiment(titanic_config.experiment_name)
    with mlflow.start_run():
        ...
        mlflow.log_param("training_data", titanic_config.experiment_name)
